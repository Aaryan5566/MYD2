...
support_chat_id = environ.get('7364818327')
reqst_channel = environ.get('1002458323029')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(7364818327) else None
...
DATABASE_NAME = environ.get('mongodb', "movie_db")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '1002398199634')).split()]
...
URL = "https://nearby-alexia-filmclan-5da387d0.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://nearby-alexia-filmclan-5da387d0.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://nearby-alexia-filmclan-5da387d0.koyeb.app/".format(FQDN)
else:
    URL = "https://nearby-alexia-filmclan-5da387d0.koyeb.app/".format(FQDN)

# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '2475059143'))
